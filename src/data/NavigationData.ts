...
export const NavigationData: NavigationDataTypes[] = [
  ...
  },
  {
    id: 2,
    label: "hooks",
    heading: "Understanding Hooks",
    content: "Hooks let you use state and lifecycle features in functional components."
  },
  {
    id: 3,
    label: "testing",
    heading: "Testing React Apps",
    content: "You can test React apps using tools like React Testing Library,Jest and Vitest."
  },
  {
    id: 4,
    label: "summary",
    heading: "Summary",
    content: "React makes it easier to build interactive and reusable UI components."
  }
];
